...
export type GetTopEndorseesQueryVariables = Exact<{
  first: Scalars['Int']['input'];
  skip: Scalars['Int']['input'];
}>;


export type GetTopEndorseesQuery = { __typename?: 'Query', accounts: Array<{ __typename?: 'Account', id: any, totalEndorsementsReceived: any }> };
...
export const GetTopEndorseesDocument = new TypedDocumentString(`
  ...
  accounts(
    ...
    `) as unknown as TypedDocumentString<GetTopEndorseesQuery, GetTopEndorseesQueryVariables>;