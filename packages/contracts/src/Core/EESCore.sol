...
import {DonationsImpl} from "./Donations/DonationsImpl.sol";

import {EndorsementsImpl} from "./Endorsements/EndorsementsImpl.sol";
import {FeesImpl} from "./Fees/FeesImpl.sol";
import {IEESCore} from "./interfaces/IEESCore.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address easAddress, bytes32 schemaUid) external initializer {
        ...
        __FeesImpl_init(0.00042 ether, 100);
    }
